...
The projects range from my thesis on clay-particle simulation to games built with other students. Each folder includes the code, setup instructions and an explanation of the work.
...
For my modelling work, start with the thesis or the heat-transfer project. For Java and testing, open Skip-Bo.

## Trying the code

The [Python particle demo](python-particle-simulation/#quick-start) is a small example to start with. The research projects need more setup, but their saved plots and results can be read without running a simulation or training a model. Each README includes the relevant checks and limitations.
